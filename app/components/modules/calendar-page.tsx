...
type EventSource = "Google Calendar" | "Apple Calendar" | "Manual" | "AI Secretary";
type ReminderPriority = "high" | "medium" | "low";
type ReminderStatus = "active" | "resolved" | "archived";
...
const SOURCE_META: Record<EventSource, { icon: typeof Calendar; dot: string }> = {
